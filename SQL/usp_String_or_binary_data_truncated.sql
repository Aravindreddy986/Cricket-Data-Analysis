...
EXEC usp_String_or_binary_data_truncated INSERT INTO matchestest select * FROM OPENROWSET('Microsoft.ACE.OLEDB.12.0', 'Excel 12.0;Database=A:\ADBMS\Project\Datafiles\csv\T20\matchestest.xlsx;HDR=YES', 'SELECT * FROM [Sheet1$]')
