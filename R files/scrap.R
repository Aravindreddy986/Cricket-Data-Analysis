...
#######################################################
loadingpath <- "A:/ADBMS/Project/Datafiles/csv/T20/output cleaned files/"
...
for(i in 1:length(file.names))
{
  ...
  filepath <- paste("A:/ADBMS/Project/Datafiles/csv/T20/output cleaned files/",file.names[i],sep = "")
  print(filepath)
  
  cricketcsfnltestt3 <- read.xlsx(filepath, sheetIndex = 1)
  cricketcsfnltestt3 <- cricketcsfnltestt3[,-1]
  
  names(cricketcsfnltestt3)<- c("desc","type1","meta","type2","type3","type4","type5","1stinningsinfo","2ndinningsinfo","overs")
  
  cricketcsfnltestt3$desc <- as.character(cricketcsfnltestt3$desc)
  cricketcsfnltestt3$type1 <- as.character(cricketcsfnltestt3$type1)
  cricketcsfnltestt3$meta <- as.character(cricketcsfnltestt3$meta)
  cricketcsfnltestt3$type2 <- as.character(cricketcsfnltestt3$type2)
  cricketcsfnltestt3$type3 <- as.character(cricketcsfnltestt3$type3)
  cricketcsfnltestt3$type4 <- as.character(cricketcsfnltestt3$type4)
  cricketcsfnltestt3$type5 <- as.character(cricketcsfnltestt3$type5)
  ...
  for (k in 1: dim(inningsnum)[2])
  {
    ...
    if(dim(bowlersactwhobowled)[1] != 0)  # checking if there are any bowlers for the match
    {
        ...
        
      {
        ...
        bowlingsummarytest <- data.frame (matchid,country, innings1stor2nd[1,2], bowlername,totalballsbowled,totaloversbowled,runsgiven, wicketstaken,dotballsbowled,economyrate, widesbowled,noballsbowled,countof6s, countof4s) 
    ...
    if ( dim(oversact)[1] != 0)
    {
      ...
      { 
        ...
        playerdetailstest <- data.frame (matchid, innings1stor2nd[1,2],country, playername,runscored[1,1], totalballsplayed, countof4s, countof6s, wicketdetails) 
...
write.xlsx(playerdetails,"A:/ADBMS/Project/Datafiles/csv/T20/Modified files/playerdetails.xlsx")
write.xlsx(matches,"A:/ADBMS/Project/Datafiles/csv/T20/Modified files/matches.xlsx")
write.xlsx(bowlingsummary,"A:/ADBMS/Project/Datafiles/csv/T20/Modified files/bowlingsummary.xlsx")
write.xlsx(fallofwickets,"A:/ADBMS/Project/Datafiles/csv/T20/Modified files/fallofwickets.xlsx")



write.xlsx(playerdetails,"A:/ADBMS/Project/Datafiles/csv/T20/Final files/playerdetails.xlsx")
write.xlsx(matches,"A:/ADBMS/Project/Datafiles/csv/T20/Final files/matches.xlsx")
write.xlsx(bowlingsummary,"A:/ADBMS/Project/Datafiles/csv/T20/Final files/bowlingsummary.xlsx")
write.xlsx(fallofwickets,"A:/ADBMS/Project/Datafiles/csv/T20/Final files/fallofwickets.xlsx")
